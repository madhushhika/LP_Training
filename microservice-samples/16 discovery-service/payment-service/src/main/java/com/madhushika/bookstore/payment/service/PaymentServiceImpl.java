...
public class PaymentServiceImpl implements PaymentService {
    ...
    private Member getMemberId(int memeberId){
        ...
        Member member=restTemplate.getForObject("http://localhost:9090/services/members/"+memeberId,Member.class);
        return member;
    ...
    private Fund getFund(int fundId){
        ...
        return restTemplate.getForObject("http://localhost:9191/services/funds/"+fundId,Fund.class);
